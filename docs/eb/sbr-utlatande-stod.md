...
| Avtal, handlingar och andra överenskommelser (10) | Ja | `eb_projects.contract_date`, `eb_projects.agreement_items`, `eb_projects.agreement_note`, `report_draft.contract_documents` |
...
Layoutregel för `Avtal, handlingar och andra överenskommelser`: uppgifterna fylls i under `Redigera entreprenad > Avtal`. ÄTA-handlingar och övriga handlingar/överenskommelser sparas strukturerat i `eb_projects.agreement_items`, med flera rader och val för om raden ska tas med i utlåtandet. Den generella kommentaren sparas i `eb_projects.agreement_note` och ska visas direkt efter den inledande avtalstexten. Därefter visas uttryckligen länkade huvudavtalshandlingar, ÄTA-handlingar och övriga handlingar/överenskommelser. Projektfiler lagras en gång i `eb_project_attachments`; bara filer som uttryckligen länkats till huvudavtalet eller en avtalsrad via `eb_project_agreement_attachment_links` får användas i detta avsnitt. Länkarna ersätts transaktionellt och en länkad fil får inte tas bort förrän avtalskopplingen först har tagits bort. Bilagans titel används som namn i Avtal och utlåtandet, medan originalfilens namn behålls. Övriga projektbilagor ska inte automatiskt listas här.
...
Noteringsförteckningen ska komma direkt efter `Fel och förhållanden`. Kolumnen `Nr` ska enbart visa sifferbeteckningen, utan entreprenadens noteringsprefix. Raderna ska visas i samma manuella ordning som i `Granska`.
