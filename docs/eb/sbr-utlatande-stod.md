...
Layoutregel för `Avtal, handlingar och andra överenskommelser`: uppgifterna fylls i under `Redigera entreprenad > Avtal`. ÄTA-handlingar och övriga handlingar/överenskommelser sparas strukturerat i `eb_projects.agreement_items`, med flera rader och val för om raden ska tas med i utlåtandet. Den generella kommentaren sparas i `eb_projects.agreement_note`. Utlåtandet ska inleda med avtalsform och kontraktsdatum, därefter lista ÄTA-handlingar och övriga handlingar/överenskommelser och sist visa den generella kommentaren. Uppladdade projektdokument/bilagor i `eb_project_attachments` ska inte automatiskt listas i detta avsnitt.
