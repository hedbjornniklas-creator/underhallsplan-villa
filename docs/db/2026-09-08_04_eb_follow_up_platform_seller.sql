-- Central HusHub seller: require refreshed consent for new purchases.
-- Apply after 2026-09-08_03_eb_follow_up_delivery_customer.sql and before the new code.
-- Existing orders retain their original seller/terms and remain recoverable.
begin;
...
begin
  ...
  if not found then
    ...
    if p_terms_version is distinct from '2026-09-08' or p_buyer->>'email' <> c.email then
