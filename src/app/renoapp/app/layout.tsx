  ...
  return (
    <RenoAppAuthGuard>
      <div className="min-h-full">
        <header className="border-b border-stone-200/80 bg-stone-50/80">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:justify-between md:px-10">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-stone-500">Styrelseportal</p>
              <h1 className="mt-1 text-2xl font-semibold tracking-tight text-stone-900">RenoApp arbetsyta</h1>
            </div>
