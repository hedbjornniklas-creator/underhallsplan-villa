...
import EbInspectionMobileRoundClient from '@/components/eb/EbInspectionMobileRoundClient'
...
export default async function EbInspectionRoundPage({
  params,
  searchParams,
}: {
