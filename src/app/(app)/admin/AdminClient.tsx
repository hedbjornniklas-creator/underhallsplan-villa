...
export default function AdminClient() {
  ...
  if (loading)
    return (
      <Protected>
        <div className="p-6">Laddarƒ?Ý</div>
      </Protected>
    )
  if (!isAdmin)
    return (
      <Protected>
        <div className="p-6 text-rose-700">Ç.tkomst nekad (endast admin).</div>
      </Protected>
    )
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left text-gray-600">
                    ...
                    <th className="py-2 pr-3">Kategori</th>
                    <th className="py-2 pr-3">Teknisk livslÇÏngd (Ç¾r)</th>
                    <th className="py-2 pr-3">UnderhÇ¾llsintervall (Ç¾r)</th>
